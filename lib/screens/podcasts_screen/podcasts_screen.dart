...
class _PodcastsScreenState extends State<PodcastsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //endDrawer: const FiltersWidget(),
      //key: filtersScaffoldKey,
      //drawer: const FiltersWidget(),
      appBar: const CustomAppBar(),
      //endDrawer: DrawerWidget(appInfo: Singleton.instance.packageInfo),// bottomNavigationBar: AppBottomBar(),
      body: Column(
