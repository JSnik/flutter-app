                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('${widget.interview.contentData.cards.length} ${Singleton.instance.translate('items_title')}' , style: AppTextStyles.main14bold, maxLines: 1,),
                        widget.interview.paidContent ? Text('${Singleton.instance.translate('paid_content_title')}' , style: AppTextStyles.main12regular, maxLines: 1,) : const SizedBox(),
                      ],
                    ),
