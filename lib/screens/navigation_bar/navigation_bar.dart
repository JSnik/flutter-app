...
class _MyNavigationBarState extends State<MyNavigationBar> {
  ...
  void initState() {
    ...
    screens = [
      ...
      WebViewScreen(url: apiBaseUrl + contestsUrl, bottomPadding: 81, hideBackButton: true,),
    ];
                      ...
                      child: Consumer<TranslationsProvider>(builder: (context, translationsProvider, _) {
                        ...
                        return PersistentTabView(
                          ...
                          onItemSelected: (index) {
                            Provider.of<MainScreenProvider>(context, listen: false).scrollControllerHomeScreen.jumpTo(0);
